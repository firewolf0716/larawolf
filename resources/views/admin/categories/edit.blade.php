...
@section('title', 'Edit '.$title['singular_name'])
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> 
      ...
      <a href="#" class="current">Edit {!! $title['singular_name'] !!}</a> </div>
    <h1>Edit {!! $title['singular_name'] !!}</h1>
  </div>
<!--End-breadcrumbs-->
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
            <h5>Edit {!! $title['singular_name'] !!}</h5>
          </div>
          <div class="widget-content nopadding">

            <form class="form-horizontal" 
                  method="post" 
                  action="{{ url('admin/category/edit/'.$detail->id) }}" 
                  name="edit_category" 
                  id="edit_category" 
